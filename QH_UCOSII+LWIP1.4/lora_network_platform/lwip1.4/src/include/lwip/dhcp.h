...
#define DHCP_SERVER_PORT  67	//dhcp服务器端口

/** DHCP client states
 * dhcp客户端状态*/
#define DHCP_OFF          0//初始状态
#define DHCP_REQUESTING   1//已发送discover报文
#define DHCP_INIT         2//
#define DHCP_REBOOTING    3//
#define DHCP_REBINDING    4//租期87.5已到，重发request报文
#define DHCP_RENEWING     5//租期50已到，重发request报文
